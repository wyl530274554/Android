...
import com.melon.myapp.adapter.GoodsAdapter;
import com.melon.myapp.bean.GoodsModel;
import com.melon.mylibrary.util.LogUtils;

import java.util.ArrayList;
import java.util.Arrays;

public class AddToCartAnim2Activity extends BaseActivity {
    // 购物车父布局
    ...
    protected void initView() {
        setContentView(R.layout.activity_add_to_cart_anim2);
    ...
    private void addGoodsToCart(ImageView goodsImg) {
        ...
        LogUtils.e("parentLocation: "+ Arrays.toString(parentLocation));
        ...
        path.quadTo((startX + toX) / 2, startY, toX, toY); //x1，y1为"控制点"的坐标值，x2，y2为终点的坐标值     (贝塞尔曲线的形成，就比如我们把一条橡皮筋拉直，橡皮筋的头尾部对应起点和终点，然后从拉直的橡皮筋中选择任意一点（除头尾对应的点外）扯动橡皮筋形成的弯曲形状，而那个扯动橡皮筋的点就是控制点；)
